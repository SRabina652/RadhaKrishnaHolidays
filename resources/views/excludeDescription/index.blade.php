...
<body>
<div class="container p-5 rounded" style="width: 900px; margin-top:100px; background-color:#eeeeee;">
        ...
        <!-- form to insert days -->
        <form action="{{route ('exclude.store')}}" method="POST" enctype="multipart/form-data" class="mt-5">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="pakage_id" class="px-3 p-1">
